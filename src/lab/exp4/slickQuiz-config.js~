...
var quizJSON = {
    ...
    "questions": [
        { // Question 1 - Multiple Choice, Single True Answer
            "q": "Which of the following is possible for Input and Output links in case of Non-Grashof linkage?",
            "a": [
                {"option": "Crank-Crank",      "correct": false},
                {"option": "Crank-Rocker",     "correct": false},
                {"option": "Rocker-Rocker",      "correct": true},
                {"option": "All",     "correct": false} // no comma here
            ],
            "correct": "<p><span>Right Answer!</span></p>",
            "incorrect": "<p><span>Wrong</span><br>Correct Answer is : Rocker-Rocker</p>" // no comma here
        },
       ...
       { // Question 3 - Multiple Choice, Multiple True Answers, Select All
            "q": "In a Non-Grashof mechanism, if longest link is fixed and shortest link is coupler which type of four bar mechanism would be formed?",
            "a": [
        ...
        { // Question 4
            "q": " Which is true for a Non-Grashof Mechanism ",
            "a": [
        ...
        { // Question 5 
            "q": "If Grashof condition is not met, which link definitely can complete a rotation ",
            "a": [
                {"option": "Shortest Link ",    "correct": false},
                {"option": "Longest Link",     "correct": false},
		 {"option": "Shorter of the remaining links",  "correct": false},
                {"option": "None of the links",  "correct": true} 


// no comma here
            ],
            "correct": "<p><span>Right Answer</span></p>",
            "incorrect": "<p><span>Wrong</span> Correct Answer Is : None of the links </p>"  // no comma here
        }
